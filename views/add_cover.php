                ...
                <div class="checkboxes">
                    <?php foreach ($widths as $width): ?>
                        <div class="radio-inline">
                            <input type="radio" name="widths[]" id="<?= $width->tag ?>" value="<?= $width->tag_id ?>"
                                   required <?= $width->tag == "12 to 14 cm" ? "checked" : '' ?>>
            ...
            <fieldset class="form-group">
                ...
                <div class="checkboxes">
                    <?php foreach ($heights as $height): ?>
                        <div class="radio-inline">
                            <input type="radio" name="heights[]" id="<?= $height->tag ?>" value="<?= $height->tag_id ?>"
                                   required <?= $height->tag == "20 to 21 cm" ? "checked" : '' ?>>
                    ...
                    <?php foreach ($thicknesses as $thickness): ?>
                        <div class="radio-inline">
                            <input type="radio" name="thicknesses[]" id="<?= $thickness->tag ?>"
                                   ...
                                   required <?= $thickness->tag == "2 to 3 cm" ? "checked" : '' ?>>
