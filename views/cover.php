        ...
        <div class="col-xs-12">
            ...
            <?php if (!empty($cover->transliterated_title) && !empty($cover->transliterated_author)): ?>
                <div class="row translated_title">
                    <h4 class="text-center">
                        (<?= $cover->transliterated_title . ' by ' . $cover->transliterated_author ?>)</h4>
                </div>
            ...
            <div class="col-xs-12 col-md-2 col-md-offset-5 text-center">
                ...
                <span class="input-group-btn">
                    <button type="button" id="amount-minus" class="btn btn-danger btn-number" data-type="minus"
                            data-field="amount">
                        <span class="glyphicon glyphicon-minus"></span>
                    </button>
                </span>
                    <input type="text" name="amount" id="amount" class="form-control input-number text-center"
                           value="<?= $cover['amount'] ?>" min="0" readonly/>
                    <span class="input-group-btn">
                    <button type="button" id="amount-plus" class="btn btn-success btn-number" data-type="plus"
                            data-field="amount">
            ...
            <div class="col-xs-12 col-md-2 col-md-offset-5 text-center">
                ...
                <?php if (!(empty($_SESSION['user_id']))): ?>
                    ...
                    <div class="input-group row">
                        <span class="input-group-btn">
                            <button type="button" id="reservation-minus" class="btn btn-danger btn-number"
                                    data-type="minus" data-field="reservation">
                                <span class="glyphicon glyphicon-minus"></span>
                            </button>
                        </span>
                        <input type="text" name="reservation" id="reservation"
                               class="form-control input-number text-center"
                               value="<?= $user_reservation ? $user_reservation->amount : 0 ?>" min="0" readonly/>
                        <span class="input-group-btn">
                            <button type="button" id="reservation-plus" class="btn btn-success btn-number"
                                    data-type="plus" data-field="reservation">
                                <span class="glyphicon glyphicon-plus"></span>
                            </button>
                        </span>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <ul class="list-group">
                                <?php foreach ($tag_list as $tag): ?>
                                    <li class="list-group-item col-xs-6 col-sm-3"><a
                                                href="tag.php?id=<?= $tag->tag_id ?>"><?= $tag->tag ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    <?php endif; ?>
